# Core_Address — Профиль адреса на территории РФ
...
Профиль Core_Address расширяет стандартный тип данных Address для описания адресов объектов, расположенных на территории Российской Федерации:
...
Для адресов вне территории Российской Федерации применяется базовый тип данных Address без требования соответствия профилю Core_Address.
