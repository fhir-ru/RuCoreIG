...
| Адрес сотрудника на территории РФ должен соответствовать требованиям | address | Для адресов на территории РФ применяется профиль Core_Address; для иностранных адресов используется базовый тип Address |
