...
Description: "Канонический набор значений RuCore для описания отношения представителя к пациенту. Соответствия внешним терминологиям оформляются отдельными ConceptMap."
