...
* kind = #identifier
* date = "2023-12-01"
* description = "Государственные идентификационные номера налогоплательщика, формируются государственной федеральной налоговой службой (ФНС России). Уникальный неизменяемый идентификатор. В RuCore используется канонический URI собственной системы идентификаторов; в российских интеграциях также встречаются OID и URI-форма OID."
* uniqueId[0]
  * type = #uri
