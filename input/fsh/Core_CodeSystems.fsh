...
* #mis-patient "Идентификатор пациента в экземпляре МИС"
* #mis-encounter "Идентификатор случая оказания медицинской помощи в экземпляре МИС"
* #mis-inpatient-record "Номер стационарной медицинской карты в экземпляре МИС"
* #mis-ambulatory-encounter "Идентификатор амбулаторного случая или посещения в экземпляре МИС"
* #mis-document-set "Идентификатор набора версий документа в экземпляре МИС"
* #mis-document "Идентификатор экземпляра документа в МИС, зависящий от версии"
* #mis-practitioner-role "Идентификатор роли медицинского работника в экземпляре МИС"
